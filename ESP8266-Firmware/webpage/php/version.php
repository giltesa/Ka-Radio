...
<body>
    ...
    <p><span class="label label-success">Release <span id="firmware-last">1.2.1</span> - Built on 2017/04/16</span></p>
    ...
    <script async="" src="./version.php_files/analytics.js.descarga"></script>
    <script>
